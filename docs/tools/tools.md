...
- XShell / FinalShell
- Xftp / FileZilla
- 科学上网（ShadowSocks，Lantern）
- Typora+iPic/  Paper / MWeb / Markdown编辑器
- Adobe Premiere Pro CC 2019
- Adobe After Effects
- Office（msoffice，wps，libreoffice）
- PostMan 模拟请求
- PostWoman
- Beyond Compare / VisualDiffer / FileMerge(mac原生提供)
- Mark Man
- Everything
- Listary
- HiJson json字符串格式化
...
- App Icon Gear
- Skip 颜色选择工具
- The Unarchiver / Archiver / BetterZip / Dr.Unarchiver 解压缩工具
- Parallels Desktop Mac上的虚拟机
- DayOne 日记记录软件
- Reveal 调试iOS UI的工具
- Cornerstones SVN版本控制工具
- spotlight mac自带应用搜索工具
- Alfred 快速打开mac上的应用
- 音速启动 windows 快速打开应用
- ZSH 终极Shell
- xScope
- Pixelmator 号称mac上的精简版photoshop
- postbox
- 网易云音乐 / QQ音乐
- LICEcap gif录制工具
- Snip 截屏
...
- TotalFinder
- Devdocs
- KMPlayer，Potplayer，IINA
- 斗图 https://www.52doutu.cn/
- 变量起名 https://unbug.github.io/codelf/
- Notion
- Notability、onenote、Things 3、Paper、Trello

参考链接：

https://www.jianshu.com/p/ec770c8a5035
